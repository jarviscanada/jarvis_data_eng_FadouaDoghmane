...
**Projet d'Analyse de Données Python** [[GitHub](https://github.com/jarviscanada/jarvis_data_eng_FadouaDoghmane/tree/master/python_data_analytics)]: Analyse des données transactionnelles du commerce de détail de LGS pour fournir des informations exploitables sur la croissance du chiffre d'affaires, la fidélisation des clients et l'optimisation marketing. Mise en place dun entrepôt de données PostgreSQL (OLAP) à partir de MS SQL Server via Docker. Nettoyage et préparation des données, calcul des indicateurs mensuels et analyse RFM avec Python (pandas, NumPy, matplotlib) pour segmenter les clients et estimer leur contribution commerciale.
